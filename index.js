...
let userText = null;
const ACCESS_KEY = "ECf1OmhY8z3BajNV7UcPm3dltCUNiwMrTj5c-m7dVNw"; // Paste your Unsplash Access Key here
...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text" style="background-image: url('images/us.jpg'); background-size: cover; background-repeat: no-repeat;">
                            <h1>ChatGPT Clone by Dhruv maheshwari</h1>
...
const getRandomUnsplashImageUrl = async () => {
